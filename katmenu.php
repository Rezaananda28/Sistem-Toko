    ...
    <div class="card">
        ...
        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <select class="from-select" name="jenismenu" id="">
            ...
            foreach ($result as $row) {
                ...
                <!-- Modal Delet-->
                <div class="modal fade" id="ModalDelet<?php echo $row['id_kat_menu'] ?>" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel"> Delet Data Kategori Menu</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_katmenu.php"
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="hapus_kategori_validate" value="1234"
                                            >Hapus</button>
                                    </div>
                                </form>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="btn btn-danger btn-sm me-1"><i class="bi bi-trash" data-bs-toggle="modal"
                                                data-bs-target="#ModalDelet<?php echo $row['id_kat_menu'] ?>"></i></button>
                                    </td>
                                    <?php
                            }
                            ?>
