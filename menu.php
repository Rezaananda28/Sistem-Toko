...
$query = mysqli_query($conn, "SELECT * FROM tb_daftar_menu
    LEFT JOIN tb_kategori_menu ON tb_kategori_menu.id_kat_menu = tb_daftar_menu.katagori");
...
<div class="col-lg-9 mt-2">
    <div class="card">
        ...
        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="input-group mb-3">
                                            ...
                                            <label class="input-group-text" for="uploadFoto">Upload Foto Meenu</label>
            ...
            <?php
            if (empty($result)) {
                echo "Data Menu makanan atau Menu tidak ada";
            } else {
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example">
                                                    ...
                                                    <?php
                                                    foreach ($select_kat_menu as $value) {
                                                        if ($row['katagori'] == $value['id_kat_menu']) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-danger btn-sm me-1"><i class="bi bi-trash"
