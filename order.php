        ...
        <div class="card-body">
            ...
            if (empty($result)) {
                ...
                foreach ($result as $row) {
                    ...
                    <!-- Modal Delet-->
                    <div class="modal fade" id="ModalDelet<?php echo $row['id_order'] ?>" tabindex="-1"
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal"
                                                data-bs-target="#ModalEdit<?php echo $row['id_order'] ?>"><i class="bi bi-trash"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#ModalDelet<?php echo $row['id_order'] ?>"></i></button>
                                        </div>
                                    </td>
                                    <?php
                            }
