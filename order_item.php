        ...
        <div class="card-body">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="from-floating mb-3">
                                            <select class="from-select" name="menu" id="">
            ...
            if (empty($result)) {
                ...
                foreach ($result as $row) {
                    ...
                    <!-- Modal Delet-->
                    <div class="modal fade" id="ModalDelet<?php echo $row['id_list_order'] ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-md modal-fullscreen-md-down">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel"> Delet Data Order</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-danger btn-sm me-1" ?>" data-bs-toggle="modal"
                                                data-bs-target="#ModalEdit<?php echo $row['id_list_order'] ?>"><i class="bi bi-trash"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#ModalDelet<?php echo $row['id_list_order'] ?>"></i></button>
                                        </div>
                                    </td>
                                    <?php
                                    $total += $row['harganya'];
