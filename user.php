                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php"
                                ...
                                <div class="form-floating">
                                    <textarea class="from-control" id="" style="height:100px" name="alamat"></textarea>
            ...
            foreach ($result as $row) {
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_input_user.php"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="from-select" arial-lebel="Default select example"
                                    ...
                                    <div class="form-floating">
                                        <textarea disabled class="from-control" id="" style="height:100px"
                ...
                <div class="modal fade" id="ModalDelet<?php echo $row['id'] ?>" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-md modal-fullscreen-md-down">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel"> Delet Data User</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php"
                                    ...
                                    <div class="col-lg-12">
                                        <?php
                                        if ($row['username'] == $_SESSION['username_detoko']) {
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-danger" name="input_user_validate" value="1234"
                                            <?php echo ($row['username'] == $_SESSION['username_detoko']) ? 'disabled' : '';
                                            ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_edit_user.php"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-floating mb-3">
                                                <input <?php  echo ($row['username'] == $_SESSION['username_detoko']) ? 'disabled' : ''; ?> type="email" class="form-control" id="floatingInput"
                                                    placeholder="name@example.com" name="username" required
                                                    value="<?php echo $row['username'] ?>">
                                                <label for="floatingInput">Username</label>
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-20" style="height:100px">
                                                <select class="from-select" arial-lebel="Default select example" required
                                                    name="level" id="">
                                                    <?php
                                                    $data = array("Owner/Admin", "Kasir", "Pelayan", "Dapur");
                                                    foreach ($data as $key => $value) {
                                    ...
                                    <div class="form-floating">
                                        <textarea class="from-control" id="" style="height:100px"
                                            name="alamat"><?php echo $row['alamat'] ?></textarea>
                                        <label for="floatingInput">Alamat</label>
                                    </div>
                                    <div class="modal-footer">
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if ($row['username'] == $_SESSION['username_detoko']) {
                                            ...
                                            echo "Apakah anda yakin ingin mereset password user <b>$row[username]</b> nenjadi password bawaan sistem yaitu <b>password</b>";
                                        }
                                        ?>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button class="btn btn-danger btn-sm me-1"><i class="bi bi-trash" data-bs-toggle="modal"
                                                data-bs-target="#ModalDelet<?php echo $row['id'] ?>"></i></button>
